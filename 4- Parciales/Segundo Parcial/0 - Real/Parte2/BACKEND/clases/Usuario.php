...
//PARTE 1
    ...
    public function TraerTablaUsu($request, $response)
    {
        ...
        if($usuarixs){
            $tabla = "<table border=1><tr><td>CORREO<td>CLAVE<td>NOMBRE<td>APELLIDO<td>PERFIL<td>FOTO";
            foreach ($usuarixs as $usuarix) {
                ...
                $tabla .= "<tr><td>" . $usuarix->correo . "<td>" . $usuarix->clave .  "<td>" . $usuarix->nombre . "<td>" . $usuarix->apellido ."<td>" . $usuarix->perfil ."<td>" . $usuarix->foto . "";
