...
class usuarix
{
    ...
    public static function AgregarUsu($usuarix)
    {
        ...
        $consulta =$objetoAccesoDato->RetornarConsulta ("INSERT INTO `usuarixs`(`nombre`, `apellido`, `mail`, `clave`, `perfil`, `estado`)
        VALUES (:nombre, :apellido, :mail, :clave, :perfil, :estado)");
